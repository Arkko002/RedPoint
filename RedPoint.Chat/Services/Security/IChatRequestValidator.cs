...
namespace RedPoint.Chat.Services.Security
{
    ...
    public interface IChatRequestValidator
    {
        ...
        /// <param name="permission">Type of permission to be checked for in user's permissions.</param>
        /// <returns>ChatError object with error details. ChatErrorType is set to NoError on valid requests.</returns>
        void IsServerRequestValid(Server server, ChatUser user, PermissionTypes permission);
        ...
        /// <param name="permission">Type of permission to be checked for in user's permissions/</param>
        /// <returns>ChatError object with error details. ChatErrorType is set to NoError on valid requests.</returns>
        void IsChannelRequestValid(Channel channel, Server server, ChatUser user,
